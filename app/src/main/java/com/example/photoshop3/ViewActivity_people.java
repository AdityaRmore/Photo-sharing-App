...
public class ViewActivity_people extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView=findViewById(R.id.viewActivity_people_Image);
        textView=findViewById(R.id.viewActivity_people_TextView);

        String View_Activity_people= getIntent().getStringExtra("View_Activity_people");
        reference.child(View_Activity_people).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){

                    String carname = snapshot.child("photo").getValue().toString();
                    final String imageurl = snapshot.child("photourl").getValue().toString();
